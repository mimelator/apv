...
public class CreateFontTool {
	...
	protected static char[] getCharacters() {
	...
	public CreateFontTool() {
	}

	public void createFont() {
		GraphicsEnvironment ge = GraphicsEnvironment.getLocalGraphicsEnvironment();
		Font[] fonts = ge.getAllFonts();
		Font instance = fonts[54];
		Font font = instance.deriveFont(Font.PLAIN, 32);
		try {
			char[] characters = getCharacters();
			System.out.println("character count: " + characters.length);
			PFont f = new PFont(font, true, characters);
			File file = new File(font.getFontName() + ".vlw");
	...
	public static class CountingOutputStream extends OutputStream {
		...
		public void write(int b) throws IOException {
			...
			if (count % 10000 == 0) {
				System.out.printf("Written %1s bytes\n", count);
			}
		}
