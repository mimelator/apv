...
public enum Command {
	...
	SWITCH_COMMAND_MODE(DeadCommandCode.next(), "Allows more advanced commands at runtime", "Enables/Disables more commands for expert users"),
	...
	RANDOMIZE_COLORS('`', "Randomize Colors", "Randomly changes the current color scheme"),
